        ...
        stage('Compile') {
            steps {
                script {
                    ...
                    javac -cp ".;lib\\junit-jupiter-api-5.11.0.jar;lib\\junit-jupiter-engine-5.11.0.jar;lib\\junit-platform-console-standalone-1.11.0.jar" -d bin JUinit_Test\\MathUtils.java JUinit_Test\\MathUtilsTest.java
                    '''
                }
            }
        }
